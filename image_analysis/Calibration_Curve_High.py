...
#path = 'C:/Users/nerea/OneDrive/Documentos/EPFL_MASTER/MA2/SensUs/LauSens_2022/image_analysis/Calibration_Results'
path = 'C:/Users/nerea/OneDrive/Documentos/EPFL_MASTER/MA2/SensUs/Results600'
#%%
...
for i in range(len(a)):
    ...
    if R>=0.85:
        ...
        conc.append(a[i,-1])
        r2s.append(R)
        plt.plot(np.arange(0, (np.shape(a)[1]-1)), a[i,:-1]-a[i,-1], cols[i],  label = a[i,-1])
 
    print(slope)
#%%
for i in range(8):
    plt.plot(data[i,:], label = conc[i])
